<template>
    <el-dialog title="上传文件" :close-on-click-modal="false" @close="closeHandle"
        :visible.sync="commonUploadvisible"></el-dialog>
    ...
    <div>
        ...
        <div class="container">
            ...
            <div>Paste your sequences with Fasta format below(click
                <el-link type="primary" style="font-size: 16px;">here</el-link>for example)
            ...
            <el-row>
                ...
                <el-col :span="6">
                    <el-upload class="upload-demo" accept=".fasta" action="https://jsonplaceholder.typicode.com/posts/"
                        ...
                        <div slot=" tip" class="el-upload__tip">只能上传fasta文件，且不超过500kb
                        </div>
                    </el-upload>
                </el-col>
